...
pub use domain::{
    ...
    CanonicalEntityId, Claim, ClaimId, ClaimPolicySpec, ClaimStatus, CompiledMemoryPolicy,
    ConditionExpr, Confidence, ContradictionRuleSpec, CustomTriggerPlugin, Entity,
    EntityGraphAttachment, EntityGraphAttachmentId, EntityGraphAttachmentType, EntityId,
    EntityResolution, EntityResolutionId, EntityResolutionStatus, EntityTypeSpec, Event, EventId,
    ...
    MemoryError, MemoryGraphError, MemoryMemberId, MemoryMemberKind, MemoryScope, MemorySubgraph,
    MemorySubgraphActivation, MemorySubgraphId, MemorySubgraphMember, MemorySubgraphMemberId,
